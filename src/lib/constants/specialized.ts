...
export const TECH_CATEGORIES: TechCategory[] = [
  {
    ...
    techs: ["React", "Node.js", "Java", ".NET", "Vue"],
    howWeSource: [
      "Pre-screened across frontend, backend & full-stack",
      "Assessed on real-world coding skills",
  ...
  },
  {
    ...
    techs: ["SQL", "Power BI", "Tableau", "Snowflake", "Spark"],
    howWeSource: [
  ...
  },
  {
    ...
    techs: ["CTO", "VP Engineering", "Tech Lead", "Engineering Manager", "Delivery Manager"],
    howWeSource: [
