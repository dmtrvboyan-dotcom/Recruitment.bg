      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-black mb-6 text-balance">
              {heroData.title}
            </h1>
            ...
            <div className="flex flex-wrap gap-8">
              {heroData.stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="text-3xl font-bold text-[#085689]">
                    {stat.value}
                  </div>
          ...
          <div className="relative">
            <div className="relative aspect-[4/3] w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-200/50">
              {/* Replace with your Smart.R hero screenshot */}
              <Image
                src="/images/smartr-hero.png"
                alt="Smart.R ATS Dashboard Overview"
                fill
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-square max-w-md mx-auto">
            ...
            <Image
              src="/images/smartr-integrations.png"
              alt="Smart.R Integrations"
              fill
...
function CTASection() {
  return (
    <section className="py-20 md:py-32 px-6 bg-gradient-to-br from-[#085689] to-[#064266]">
